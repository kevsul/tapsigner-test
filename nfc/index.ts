...
import { simSocket } from './sim-socket';
...
async function init() {
  try {
    ...
    // const msg = selectApp.toJSON();
    // const hexmsg = '00a404000ff0436f696e6b697465434152447631';

    // const selectResponse = await simSocket.transceive(
...
async function send(cmd: string, args: any) {
  ...
  const r = await simSocket.transceive(bytes);
